...
### Equation Layer
- Write LaTeX and insert beautifully rendered equations onto the canvas
- Live preview as you type with MathML output for full fidelity
- Click any equation to reopen and edit it
- 40+ pre-built expression library across 9 categories (algebra, calculus, trig, matrices, geometry, and more)
